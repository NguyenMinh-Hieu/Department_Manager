...
public class DepartmentController {
    ...
    @PutMapping("/{id}")
    public void updateById(@PathVariable("id") @DepartmentIdExists Integer id, @RequestBody DepartmentUpdateForm form) {
        form.setId(id);
    ...
    @DeleteMapping()
    public void deleteAll(@RequestBody List<@DepartmentIdExists Integer> ids) {
