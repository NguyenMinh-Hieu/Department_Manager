...
public class AccountController {
    ...
    @PostMapping
    public void create(@RequestBody AccountCreateForm account) {
        service.create(account);
    }

    @PutMapping("/{id}")
    public void updateById(@PathVariable("id") Integer id,@RequestBody AccountUpdateForm form) {
        form.setId(id);
    ...
    @DeleteMapping
    public void deleteAll(@RequestBody List<@AccountIdExists Integer> ids) {
